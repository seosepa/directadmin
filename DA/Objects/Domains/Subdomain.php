...
/**
 * DA_Objects_Domains_Subdomain
 *
 * @author Niels Keurentjes <niels.keurentjes@omines.com>
 */
class DA_Objects_Domains_Subdomain extends DA_Objects_DomainObject
{
    /**
     ...
     */
    public function __construct($prefix, DA_Objects_Domain $domain)
    {
     ...
     * @return DA_Objects_Domains_Subdomain The newly created object.
     */
    public static function create(DA_Objects_Domain $domain, $prefix)
    {
