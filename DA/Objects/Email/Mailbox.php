 ...
 */
class DA_Objects_Email_Mailbox extends DA_Objects_Email_MailObject
{
     ...
     */
    public function __construct($prefix, DA_Objects_Domain $domain, $config = null)
    {
     ...
     * @return DA_Objects_Email_Mailbox The created mailbox.
     */
    public static function create(DA_Objects_Domain $domain, $prefix, $password, $quota = null, $sendLimit = null)
    {
