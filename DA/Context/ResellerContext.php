 ...
 */
class DA_Context_ResellerContext extends DA_Context_UserContext
{
    /**
    ...
    public function createUser($username, $password, $email, $domain, $ip, $package = [])
    {
        ...
        return $this->createAccount($username, $password, $email, $options, 'ACCOUNT_USER', 'DA_Objects_Users_User');
    }
    ...
    {
        return DA_Objects_Object::toObjectArray($this->invokeGet('SHOW_USERS'), 'DA_Objects_Users_User', $this);
    }
    ...
    {
        return new DA_Context_UserContext($this->getConnection()->loginAs($username), $validate);
    }
}
